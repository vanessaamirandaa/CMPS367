...
void displayYearMeaning(int year) {
    switch(year) {
        ...
        case 2001:
            ...
            break;
        case 2002:
            cout << "The year 2002 means that you are the ceneter of attention and need discipline." << endl;
            break;
        case 2003:
        ...
        case 2005:
            ...
            break;
        case 2006:
            cout << "The year 2006 means that you are straightfoward in thought and speech." << endl;
            break;
        case 2007:
